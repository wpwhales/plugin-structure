...
use WPWCore\Assets\Contracts\Manifest as ManifestContract;
use WPWCore\Assets\Contracts\ManifestNotFoundException;
use WPWCore\Assets\Middleware\LaravelMixMiddleware;
use WPWCore\Assets\Middleware\RootsBudMiddleware;

/**
 * Manage assets manifests
 *
 * @see \WPWhales\Support\Manager
 * @link https://github.com/WPWhales/support/blob/8.x/Manager.php
 */
class Manager
{
    /**
