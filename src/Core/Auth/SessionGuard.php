...
use WPWCore\Auth\Events\Attempting;
use WPWCore\Auth\Events\Authenticated;
use WPWCore\Auth\Events\CurrentDeviceLogout;
use WPWCore\Auth\Events\Failed;
use WPWCore\Auth\Events\Login;
use WPWCore\Auth\Events\Logout;
use WPWCore\Auth\Events\OtherDeviceLogout;
use WPWCore\Auth\Events\Validated;
use WPWhales\Contracts\Auth\Authenticatable as AuthenticatableContract;
use WPWhales\Contracts\Auth\StatefulGuard;
use WPWhales\Contracts\Auth\SupportsBasicAuth;
...
use WPWhales\Support\Timebox;
use WPWhales\Support\Traits\Macroable;
use function WPWhales\Auth\tap;
...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     *
     * @var \WPWhales\Contracts\Session\Session
     */
    protected $session;

    /**
     * The WPWhales cookie creator service.
     *
     ...
     * @param  \WPWhales\Support\Timebox|null  $timebox
     * @return void
     */
     ...
     *
     * @param  \WPWCore\Auth\Recaller  $recaller
     * @return mixed
     */
     ...
     *
     * @return \WPWCore\Auth\Recaller|null
     */
     ...
     *
     * @param  mixed  $id
     * @return \WPWhales\Contracts\Auth\Authenticatable|false
     */
    ...
    {
        $this->events?->listen(\WPWCore\Auth\Events\Attempting::class, $callback);
    }
     ...
     *
     * @return \WPWhales\Contracts\Cookie\QueueingFactory
     *
     ...
     *
     * @param  \WPWhales\Contracts\Cookie\QueueingFactory  $cookie
     * @return void
     */
     ...
     *
     * @return \WPWhales\Support\Timebox
     */
