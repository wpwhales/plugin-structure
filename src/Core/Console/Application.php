...
use Closure;
use WPWCore\Console\Events\ArtisanStarting;
...
class Application extends SymfonyApplication implements ApplicationContract
{
    ...
    {
        parent::__construct('WPWhales Artisan', $version);
     ...
     *
     * @param  \WPWCore\Console\Command|string  $command
    ...
    {
        return \WPWCore\Support\tap(parent::getDefaultInputDefinition(), function ($definition) {
