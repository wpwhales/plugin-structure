...
abstract class GeneratorCommand extends Command implements PromptsForMissingInput
{
    ...
    public function __construct(Filesystem $files)
    {
        ...
        if (in_array(CreatesMatchingTest::class, \WPWCore\Support\class_uses_recursive($this))) {
            $this->addTestOptions();
        }
    ...
    protected function possibleModels()
    {
        ...
        return \WPWCore\Collections\collect((new Finder)->files()->depth(0)->in($modelPath))
    ...
    protected function possibleEvents()
    {
        ...
        return \WPWCore\Collections\collect((new Finder)->files()->depth(0)->in($eventPath))
            ->map(fn($file) => $file->getBasename('.php'))
            ->values()
            ->all();
    }
