...
use WPWCore\Console\QuestionHelper;
use ReflectionClass;
...
abstract class Component
{
    ...
    protected function compile($view, $data)
    {
        ...
        return \WPWCore\Support\tap(ob_get_contents(), function () {
            ob_end_clean();
        });
    }
    ...
    {
        $property = \WPWCore\Support\with(new ReflectionClass(OutputStyle::class))
            ->getParentClass()
