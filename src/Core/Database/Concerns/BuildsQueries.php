...
namespace WPWCore\Database\Concerns;
...
use WPWCore\Database\MultipleRecordsFoundException;
...
;
     ...
     * @return \WPWCore\Database\Eloquent\Model|object|static|null
     */
        ...
        if (! is_null($cursor)) {
            $addCursorConditions = function (self $builder, $previousColumn, $i) use (&$addCursorConditions, $cursor, $orders) {
                $unionBuilders = isset($builder->unions) ? \WPWCore\Collections\collect($builder->unions)
                    ->pluck('query') : \WPWCore\Collections\collect()
;
     ...
     *
     * @param  \WPWCore\Database\Query\Builder|\WPWCore\Database\Eloquent\Builder  $builder
