...
use WPWCore\Database\Events\QueryExecuted;
use WPWCore\Database\Events\StatementPrepared;
use WPWCore\Database\Events\TransactionBeginning;
use WPWCore\Database\Events\TransactionCommitted;
use WPWCore\Database\Events\TransactionCommitting;
use WPWCore\Database\Events\TransactionRolledBack;
use WPWCore\Database\Query\Builder as QueryBuilder;
use WPWCore\Database\Query\Expression;
use WPWCore\Database\Query\Grammars\Grammar as QueryGrammar;
use WPWCore\Database\Query\Processors\Processor;
use WPWCore\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \WPWCore\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \WPWCore\Database\DatabaseTransactionsManager
     */
     ...
     *
     * @return \WPWCore\Database\Schema\Grammars\Grammar|null
     */
     ...
     *
     * @return \WPWCore\Database\Schema\Builder
     */
     ...
     *
     * @param  \Closure|\WPWCore\Database\Query\Builder|\WPWhales\Contracts\Database\Query\Expression|string  $table
     ...
     * @return mixed
     *
     * @throws \WPWCore\Database\MultipleColumnsSelectedException
     */
     ...
     * @return mixed
     *
     * @throws \WPWCore\Database\QueryException
     */
     ...
     *
     * @param  \WPWCore\Database\QueryException  $e
     * @param  string  $query
     * @param  array  $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     * @return mixed|false
     *
     * @throws \WPWCore\Database\LostConnectionException
     */
     ...
     *
     * @param  \WPWCore\Database\Query\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @return \WPWCore\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @param  \WPWCore\Database\Schema\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @param  \WPWCore\Database\Query\Processors\Processor  $processor
     * @return $this
     */
     ...
     *
     * @param  \WPWCore\Database\DatabaseTransactionsManager  $manager
     * @return $this
     */
     ...
     * @return \WPWCore\Database\Grammar
     */
