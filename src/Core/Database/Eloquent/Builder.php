...
use WPWCore\Database\Eloquent\Concerns\QueriesRelationships;
...
use WPWCore\Database\RecordsNotFoundException;
use WPWCore\Database\UniqueConstraintViolationException;
 ...
 *
 * @mixin \WPWCore\Database\Query\Builder
 */
class Builder implements BuilderContract
{
     ...
     *
     * @var \WPWCore\Database\Query\Builder
     */
    protected $query;
     ...
     * @return \WPWCore\Database\Eloquent\Model|static
     */
     ...
     * @param  \WPWCore\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \WPWCore\Database\Eloquent\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \WPWCore\Database\Eloquent\Model|static|null
     */
     ...
     * @return \WPWCore\Database\Eloquent\Model|\WPWCore\Database\Eloquent\Collection|static[]|static|null
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return \WPWCore\Database\Eloquent\Model|\WPWCore\Database\Eloquent\Collection|static|static[]
     *
     * @throws \WPWCore\Database\Eloquent\ModelNotFoundException<\WPWCore\Database\Eloquent\Model>
     */
     ...
     * @return \WPWCore\Database\Eloquent\Model|\WPWCore\Database\Eloquent\Collection|static[]|static|mixed
     */
     ...
     * @param  \Closure|array|string  $columns
     * @param  \Closure|null  $callback
     * @return \WPWCore\Database\Eloquent\Model|static|mixed
     */
     ...
     *
     * @param  array|string  $columns
     * @return \WPWCore\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \WPWCore\Database\Eloquent\Relations\Relation
     */
     ...
     *
     * @param  array  $attributes
     * @return \WPWCore\Database\Eloquent\Model|$this
     */
