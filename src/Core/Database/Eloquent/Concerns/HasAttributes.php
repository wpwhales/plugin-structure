...
use WPWCore\Database\Eloquent\Casts\AsArrayObject;
use WPWCore\Database\Eloquent\Casts\AsCollection;
use WPWCore\Database\Eloquent\Casts\AsEncryptedArrayObject;
use WPWCore\Database\Eloquent\Casts\AsEncryptedCollection;
use WPWCore\Database\Eloquent\Casts\AsEnumArrayObject;
use WPWCore\Database\Eloquent\Casts\AsEnumCollection;
use WPWCore\Database\Eloquent\Casts\Attribute;
use WPWCore\Database\Eloquent\Casts\Json;
use WPWCore\Database\Eloquent\InvalidCastException;
use WPWCore\Database\Eloquent\JsonEncodingException;
use WPWCore\Database\Eloquent\MissingAttributeException;
use WPWCore\Database\Eloquent\Relations\Relation;
use WPWCore\Database\LazyLoadingViolationException;
...
trait HasAttributes
{
     ...
     * @return null
     *
     * @throws \WPWCore\Database\Eloquent\MissingAttributeException
     */
     ...
     * @return bool
     *
     * @throws \WPWCore\Database\Eloquent\InvalidCastException
     */
