...
use Closure;
use WPWCore\Database\Eloquent\Scope;
...
trait HasGlobalScopes
{
     ...
     *
     * @param  \WPWCore\Database\Eloquent\Scope|\Closure|string  $scope
     * @param  \WPWCore\Database\Eloquent\Scope|\Closure|null  $implementation
     * @return mixed
     *
     ...
     *
     * @param  \WPWCore\Database\Eloquent\Scope|string  $scope
     * @return \WPWCore\Database\Eloquent\Scope|\Closure|null
     */
