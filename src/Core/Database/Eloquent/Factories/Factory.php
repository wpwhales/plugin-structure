...
/**
 * @template TModel of \WPWCore\Database\Eloquent\Model
 *
 * @method $this trashed()
 */
abstract class Factory
{
     ...
     *
     * @var class-string<\WPWCore\Database\Eloquent\Model|TModel>
     */
    protected $model;
     ...
     * @param  \WPWhales\Support\Collection|null  $states
     * @param  \WPWhales\Support\Collection|null  $has
     * @param  \WPWhales\Support\Collection|null  $for
     * @param  \WPWhales\Support\Collection|null  $afterMaking
     * @param  \WPWhales\Support\Collection|null  $afterCreating
     * @param  string|null  $connection
     * @param  \WPWhales\Support\Collection|null  $recycle
     * @return void
     */
     ...
     *
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \WPWCore\Database\Eloquent\Model|null  $parent
     ...
     *
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @return \WPWCore\Database\Eloquent\Model|TModel
     */
     ...
     * @return \WPWCore\Database\Eloquent\Collection<int, \WPWCore\Database\Eloquent\Model|TModel>
     */
     ...
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \WPWCore\Database\Eloquent\Model|null  $parent
     * @return \WPWCore\Database\Eloquent\Collection<int, \WPWCore\Database\Eloquent\Model|TModel>|\WPWCore\Database\Eloquent\Model|TModel
     */
     ...
     * @param  \WPWCore\Database\Eloquent\Model|null  $parent
     * @return \Closure(): (\WPWCore\Database\Eloquent\Collection<int, \WPWCore\Database\Eloquent\Model|TModel>|\WPWCore\Database\Eloquent\Model|TModel)
     */
     ...
     *
     * @param  \WPWhales\Support\Collection  $results
     * @return void
     */
     ...
     *
     * @param  (callable(array<string, mixed>, \WPWCore\Database\Eloquent\Model|null): array<string, mixed>)|array<string, mixed>  $state
     * @return static
     */
     ...
     *
     * @param  \WPWCore\Database\Eloquent\Factories\Factory  $factory
     ...
     *
     * @param  \WPWCore\Database\Eloquent\Factories\Factory|\WPWhales\Support\Collection|\WPWCore\Database\Eloquent\Model|array  $factory
     ...
     *
     * @param  \WPWCore\Database\Eloquent\Factories\Factory|\WPWCore\Database\Eloquent\Model  $factory
     * @param  string|null  $relationship
     * @return static
     */
     ...
     *
     * @param  \WPWCore\Database\Eloquent\Model|\WPWhales\Support\Collection|array  $model
     * @return static
     */
     ...
     * @return \WPWCore\Database\Eloquent\Model|null
     */
     ...
     *
     * @param  \Closure(\WPWCore\Database\Eloquent\Model|TModel): mixed  $callback
     * @return static
     */
     ...
     *
     * @param  \WPWhales\Support\Collection  $instances
     * @return void
     */
     ...
     *
     * @return class-string<\WPWCore\Database\Eloquent\Model|TModel>
     */
     ...
     *
     * @param  callable(self): class-string<\WPWCore\Database\Eloquent\Model|TModel>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<\WPWCore\Database\Eloquent\Model>  $modelName
     * @return \WPWCore\Database\Eloquent\Factories\Factory
     */
     ...
     *
     * @param  callable(class-string<\WPWCore\Database\Eloquent\Model>): class-string<\WPWCore\Database\Eloquent\Factories\Factory>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<\WPWCore\Database\Eloquent\Model>  $modelName
     * @return class-string<\WPWCore\Database\Eloquent\Factories\Factory>
     */
