...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     * @return $this
     *
     * @throws \WPWCore\Database\Eloquent\MassAssignmentException
     */
     ...
     * @return \WPWCore\Database\Eloquent\Collection<int, static>
     */
     ...
     * @return \WPWCore\Database\Eloquent\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \WPWCore\Database\Eloquent\JsonEncodingException
     */
     ...
     *
     * @return \WPWCore\Database\ConnectionResolverInterface|null
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \WPWCore\Database\Eloquent\Model|\WPWCore\Database\Eloquent\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \WPWCore\Database\Eloquent\Relations\Relation
     */
