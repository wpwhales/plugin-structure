...
/**
 * @method static \WPWCore\Database\Eloquent\Builder|\WPWCore\Database\Query\Builder withTrashed(bool $withTrashed = true)
 * @method static \WPWCore\Database\Eloquent\Builder|\WPWCore\Database\Query\Builder onlyTrashed()
 * @method static \WPWCore\Database\Eloquent\Builder|\WPWCore\Database\Query\Builder withoutTrashed()
 */
trait SoftDeletes
{
    /**
