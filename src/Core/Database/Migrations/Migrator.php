...
namespace WPWCore\Database\Migrations;
...
use WPWCore\Console\View\Components\Info;
use WPWCore\Console\View\Components\Task;
...
use WPWCore\Database\Events\MigrationEnded;
use WPWCore\Database\Events\MigrationsEnded;
use WPWCore\Database\Events\MigrationsStarted;
use WPWCore\Database\Events\MigrationStarted;
use WPWCore\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var array<string, \WPWCore\Database\Migrations\Migration|null>
     */
     ...
     *
     * @return \WPWCore\Database\Migrations\MigrationRepositoryInterface
     */
