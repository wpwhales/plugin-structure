...
use WPWCore\Database\Concerns\BuildsQueries;
use WPWCore\Database\Concerns\ExplainsQueries;
use WPWCore\Database\ConnectionInterface;
use WPWCore\Database\Eloquent\Builder as EloquentBuilder;
use WPWCore\Database\Eloquent\Relations\Relation;
use WPWCore\Database\Query\Grammars\Grammar;
use WPWCore\Database\Query\Processors\Processor;
...
class Builder implements BuilderContract
{
     ...
     *
     * @var \WPWCore\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \WPWCore\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \WPWCore\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     * @param  \WPWCore\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \WPWCore\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\WPWCore\Database\Query\Builder|\WPWCore\Database\Eloquent\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\WPWCore\Database\Query\Builder|\WPWCore\Database\Eloquent\Builder|string  $table
     ...
     *
     * @param  \WPWCore\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \WPWCore\Database\Query\JoinClause
     */
     ...
     *
     * @param  \WPWCore\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     * @param  \WPWhales\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure||\WPWCore\Database\Query\Builder|\WPWCore\Database\Eloquent\Builder  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\WPWCore\Database\Query\Builder|\WPWCore\Database\Eloquent\Builder|\WPWhales\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\WPWCore\Database\Query\Builder|\WPWhales\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\WPWCore\Database\Query\Builder|\WPWhales\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\WPWCore\Database\Query\Builder|\WPWCore\Database\Eloquent\Builder  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \WPWCore\Database\RecordsNotFoundException
     * @throws \WPWCore\Database\MultipleRecordsFoundException
     */
    ...
    public function paginate($perPage = 15, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        $results = $total ? $this->forPage($page, $perPage)->get($columns) : \WPWCore\Collections\collect()
;
     ...
     *
     * @return \WPWCore\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \WPWCore\Database\Query\Grammars\Grammar
     */
    ...
    {
        return \WPWCore\Support\tap($this->clone(), function ($clone) use ($properties) {
    ...
    {
        return \WPWCore\Support\tap($this->clone(), function ($clone) use ($except) {
