...
use WPWCore\Database\Eloquent\Concerns\HasUlids;
use WPWCore\Database\Query\Expression;
use WPWCore\Database\Schema\Grammars\Grammar;
...
class Blueprint
{
     ...
     *
     * @var \WPWCore\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     * @return \WPWCore\Database\Schema\IndexDefinition
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \WPWCore\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \WPWCore\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \WPWCore\Database\Schema\ForeignIdColumnDefinition
     */
...
;
     ...
     *
     * @param  \WPWCore\Database\Schema\ColumnDefinition  $definition
     * @return \WPWCore\Database\Schema\ColumnDefinition
     */
