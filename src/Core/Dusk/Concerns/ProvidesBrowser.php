...
trait ProvidesBrowser
{
     ...
     *
     * @param  \Closure  $callback
     * @return \WPWCore\Dusk\Browser|void
     *
     * @throws \Exception
     * @throws \Throwable
     */
    ...
    protected function createBrowsersFor(Closure $callback)
    {
        if (count(static::$browsers) === 0) {
            static::$browsers = \WPWCore\Collections\collect([$this->newBrowser($this->createWebDriver())]);
        }
     ...
     *
     * @param  \WPWhales\Support\Collection  $browsers
     * @return void
     */
    ...
    {
        return \WPWCore\retry(5, function () {
            return $this->driver();
        }, 50);
    }
