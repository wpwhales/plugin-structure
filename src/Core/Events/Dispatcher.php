...
use WPWhales\Contracts\Events\ShouldDispatchAfterCommit;
use WPWhales\Contracts\Events\ShouldHandleEventsAfterCommit;
...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @param  mixed  $listener
     * @param  \WPWCore\Events\CallQueuedListener  $job
     * @return mixed
     */
