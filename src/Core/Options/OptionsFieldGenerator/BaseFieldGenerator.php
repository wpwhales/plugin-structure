...
use WPWCore\Options\Contracts\OptionsFieldGenerator as OptionsFieldGeneratorContract;
...
abstract class BaseFieldGenerator implements OptionsFieldGeneratorContract
{
     ...
     * @return void
     */
     private static function enqueueAssetsOnce($optionsPage)
    {
...
//        $isEnqueued = true;
     ...
     */
     private static function setInstanceTemplateOnce($instance)
    {



        if(!empty(static::$template)){
            $instance->templateInstance = view("options.".static::$template);
        }else{
     ...
     * @return string|null
     */
     private function normalizeFieldName($originalFieldName)
    {
     ...
     * @return null|string
     */
    private function normalizeFieldValue($originalFieldName)
    {
    ...
    {
        return $this->templateInstance->with($data)->render();
    }
