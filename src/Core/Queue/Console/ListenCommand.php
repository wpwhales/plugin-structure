...
use WPWCore\Queue\Listener;
use WPWCore\Queue\ListenerOptions;
...
class ListenCommand extends Command
{
     ...
     *
     * @param  \WPWCore\Queue\Listener  $listener
     * @return void
     */
    ...
    public function handle()
    {
        ...
        $this->components->info(sprintf('Processing jobs from the [%s] %s.', $queue, \WPWCore\Support\str('queue')->plural(explode(',', $queue))));
     ...
     *
     * @return \WPWCore\Queue\ListenerOptions
     */
