...
use WPWCore\Queue\Jobs\DatabaseJob;
use WPWCore\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \WPWCore\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string  $queue
     * @param  \WPWCore\Queue\Jobs\DatabaseJobRecord  $job
     * @param  int  $delay
     * @return mixed
     */
     ...
     *
     * @param  string|null  $queue
     * @return \WPWCore\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \WPWCore\Queue\Jobs\DatabaseJobRecord  $job
     * @return \WPWCore\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  string  $queue
     * @param  \WPWCore\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
