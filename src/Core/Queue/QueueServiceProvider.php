...
use WPWCore\Queue\Connectors\DatabaseConnector;
use WPWCore\Queue\Connectors\NullConnector;
use WPWCore\Queue\Connectors\RedisConnector;
use WPWCore\Queue\Connectors\SqsConnector;
use WPWCore\Queue\Connectors\SyncConnector;
use WPWCore\Queue\Failed\DatabaseFailedJobProvider;
use WPWCore\Queue\Failed\DatabaseUuidFailedJobProvider;
use WPWCore\Queue\Failed\DynamoDbFailedJobProvider;
use WPWCore\Queue\Failed\FileFailedJobProvider;
use WPWCore\Queue\Failed\NullFailedJobProvider;
...
//        $this->configureSerializableClosureUses();
    ...
    protected function registerManager()
    {
        $this->app->singleton('queue', function ($app) {
            ...
            return \WPWCore\tap(new QueueManager($app), function ($manager) {
     ...
     *
     * @param  \WPWCore\Queue\QueueManager  $manager
     * @return void
     */
     ...
     *
     * @param  array  $config
     * @return \WPWCore\Queue\Failed\DatabaseFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \WPWCore\Queue\Failed\DatabaseUuidFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \WPWCore\Queue\Failed\DynamoDbFailedJobProvider
     */
