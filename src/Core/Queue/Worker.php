...
use WPWCore\Database\DetectsLostConnections;
use WPWCore\Queue\Events\JobExceptionOccurred;
use WPWCore\Queue\Events\JobPopped;
use WPWCore\Queue\Events\JobPopping;
...
use WPWCore\Queue\Events\JobTimedOut;
use WPWCore\Queue\Events\Looping;
use WPWCore\Queue\Events\WorkerStopping;
...
class Worker
{
    ...
    {
        if ($this->cache) {
            return $this->cache->get('wpwcore:queue:restart');
        }
    }
