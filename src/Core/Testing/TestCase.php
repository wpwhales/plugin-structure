...
abstract class TestCase extends BaseTestCase
{
    ...
    public function expectsEvents($events)
    {
        ...
        $mock = Mockery::spy(\WPWhales\Contracts\Events\Dispatcher::class);
    ...
    {
        $mock = Mockery::mock(\WPWhales\Contracts\Events\Dispatcher::class);
    ...
    protected function expectsJobs($jobs)
    {
        ...
        $mock = Mockery::mock('WPWhales\Bus\Dispatcher[dispatch]', [$this->app]);
        ...
        $this->app->instance(
            \WPWhales\Contracts\Bus\Dispatcher::class, $mock
        );
