...
use WPWhales\Broadcasting\Broadcasters\AblyBroadcaster;
use WPWhales\Broadcasting\Broadcasters\LogBroadcaster;
use WPWhales\Broadcasting\Broadcasters\NullBroadcaster;
use WPWhales\Broadcasting\Broadcasters\PusherBroadcaster;
use WPWhales\Broadcasting\Broadcasters\RedisBroadcaster;
use WPWhales\Bus\UniqueLock;
use WPWhales\Contracts\Broadcasting\Factory as FactoryContract;
use WPWhales\Contracts\Broadcasting\ShouldBeUnique;
use WPWhales\Contracts\Broadcasting\ShouldBroadcastNow;
...
/**
 * @mixin \WPWhales\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param  \WPWhales\Contracts\Container\Container  $app
     * @return void
     */
    ...
    public function routes(array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\WPWhales\Foundation\Http\Middleware\VerifyCsrfToken::class]);
        });
    }
