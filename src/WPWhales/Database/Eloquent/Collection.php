...
class Collection extends BaseCollection implements QueueableCollection
{
     ...
     *
     * @param  array<array-key, (callable(\WPWhales\Database\Eloquent\Builder): mixed)|string>|string  $relations
     * @return $this
     */
     ...
     * @param  array<array-key, (callable(\WPWhales\Database\Eloquent\Builder): mixed)|string>  $relations
     * @return $this
     */
