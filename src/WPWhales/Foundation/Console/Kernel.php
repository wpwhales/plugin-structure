...
class Kernel implements KernelContract
{
     ...
     *
     * @var \WPWhales\Console\Application|null
     */
    protected $artisan;
    ...
    protected $bootstrappers = [
        ...
        \WPWhales\Foundation\Bootstrap\SetRequestForConsole::class,
     ...
     * @return \WPWhales\Foundation\Console\ClosureCommand
     */
    ...
    public function bootstrapWithoutBootingProviders()
    {
        $this->app->bootstrapWith(
            collect($this->bootstrappers())->reject(function ($bootstrapper) {
                return $bootstrapper === \WPWhales\Foundation\Bootstrap\BootProviders::class;
            })->all()
        );
    }
     ...
     *
     * @param  \WPWhales\Console\Application|null  $artisan
     * @return void
     */
