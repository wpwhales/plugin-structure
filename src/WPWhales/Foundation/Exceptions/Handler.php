...
namespace WPWhales\Foundation\Exceptions;
...
use WPWhales\Cache\RateLimiting\Limit;
...
use WPWhales\Contracts\Debug\ExceptionHandler as ExceptionHandlerContract;
use WPWhales\Contracts\Foundation\ExceptionRenderer;
...
use WPWhales\Routing\Exceptions\BackedEnumCaseNotFoundException;
use WPWhales\Routing\Router;
use WPWhales\Session\TokenMismatchException;
use WPWhales\Support\Arr;
use WPWhales\Support\Facades\Auth;
use WPWhales\Support\Lottery;
...
class Handler implements ExceptionHandlerContract
{
     ...
     *
     * @var \WPWhales\Foundation\Exceptions\ReportableHandler[]
     */
     ...
     * @return \WPWhales\Foundation\Exceptions\ReportableHandler
     */
    ...
    protected function shouldntReport(Throwable $e)
    {
        ...
        return rescue(fn () => with($this->throttle($e), function ($throttle) use ($e) {
            ...
            return ! $this->container->make(RateLimiter::class)->attempt(
                with($throttle->key ?: 'WPWhales:foundation:exceptions:'.$e::class, fn ($key) => $this->hashThrottleKeys ? md5($key) : $key),
     ...
     *
     * @param  \Throwable  $e
     * @return \WPWhales\Support\Lottery|\WPWhales\Cache\RateLimiting\Limit|null
     */
     ...
     * @param  \WPWhales\Http\Request  $request
     * @param  \Throwable  $e
     * @return \WPWhales\Http\Response|\WPWhales\Http\JsonResponse|\WPWhales\Http\RedirectResponse
     */
     ...
     *
     * @param  \WPWhales\Http\Request  $request
     * @param  \WPWhales\Auth\AuthenticationException  $exception
     * @return \WPWhales\Http\Response|\WPWhales\Http\JsonResponse|\WPWhales\Http\RedirectResponse
     */
     ...
     *
     * @param  \WPWhales\Validation\ValidationException  $e
     * @param  \WPWhales\Http\Request  $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param  \WPWhales\Http\Request  $request
     * @param  \WPWhales\Validation\ValidationException  $exception
     * @return \WPWhales\Http\Response|\WPWhales\Http\JsonResponse|\WPWhales\Http\RedirectResponse
     */
    ...
    protected function prepareResponse($request, Throwable $e)
    {
        if (! $this->isHttpException($e) && config('app.debug')) {
            return $this->toWPWhalesResponse($this->convertExceptionToResponse($e), $e)->prepare($request);
        }
        ...
        return $this->toWPWhalesResponse(
    ...
    /**
     * Map the given exception into an WPWhales response.
     *
     * @param  \Symfony\Component\HttpFoundation\Response  $response
     * @param  \Throwable  $e
     * @return \WPWhales\Http\Response|\WPWhales\Http\RedirectResponse
     */
    protected function toWPWhalesResponse($response, Throwable $e)
    {
