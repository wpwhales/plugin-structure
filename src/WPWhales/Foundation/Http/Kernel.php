...
use WPWhales\Contracts\Http\Kernel as KernelContract;
use WPWhales\Foundation\Http\Events\RequestHandled;
use WPWhales\Routing\Pipeline;
...
class Kernel implements KernelContract
{
    ...
    protected $bootstrappers = [
        \WPWhales\Foundation\Bootstrap\LoadEnvironmentVariables::class,
        \WPWhales\Foundation\Bootstrap\LoadConfiguration::class,
        \WPWhales\Foundation\Bootstrap\HandleExceptions::class,
        \WPWhales\Foundation\Bootstrap\RegisterFacades::class,
        \WPWhales\Foundation\Bootstrap\RegisterProviders::class,
        \WPWhales\Foundation\Bootstrap\BootProviders::class,
    ];
    ...
    protected $middlewarePriority = [
        \WPWhales\Foundation\Http\Middleware\HandlePrecognitiveRequests::class,
        \WPWhales\Cookie\Middleware\EncryptCookies::class,
        \WPWhales\Cookie\Middleware\AddQueuedCookiesToResponse::class,
        \WPWhales\Session\Middleware\StartSession::class,
        \WPWhales\View\Middleware\ShareErrorsFromSession::class,
        \WPWhales\Contracts\Auth\Middleware\AuthenticatesRequests::class,
        \WPWhales\Routing\Middleware\ThrottleRequests::class,
        \WPWhales\Routing\Middleware\ThrottleRequestsWithRedis::class,
        \WPWhales\Contracts\Session\Middleware\AuthenticatesSessions::class,
        \WPWhales\Routing\Middleware\SubstituteBindings::class,
        \WPWhales\Auth\Middleware\Authorize::class,
    ];
     ...
     *
     * @return \WPWhales\Support\Carbon|null
     */
