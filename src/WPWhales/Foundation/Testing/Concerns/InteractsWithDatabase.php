...
use WPWhales\Testing\Constraints\CountInDatabase;
use WPWhales\Testing\Constraints\HasInDatabase;
use WPWhales\Testing\Constraints\NotSoftDeletedInDatabase;
use WPWhales\Testing\Constraints\SoftDeletedInDatabase;
...
trait InteractsWithDatabase
{
     ...
     *
     * @param  \WPWhales\Database\Eloquent\Model|string  $table
     * @param  array  $data
