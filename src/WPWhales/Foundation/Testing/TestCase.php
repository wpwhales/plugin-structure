...
use WPWhales\Foundation\Bootstrap\HandleExceptions;
use WPWhales\Foundation\Http\Middleware\ConvertEmptyStringsToNull;
use WPWhales\Foundation\Http\Middleware\TrimStrings;
use WPWhales\Queue\Queue;
use WPWhales\Support\Carbon;
use WPWhales\Support\Facades\Facade;
use WPWhales\Support\Facades\ParallelTesting;
...
abstract class TestCase extends BaseTestCase
{
    ...
    /**
     * The WPWhales application instance.
     *
     * @var \WPWhales\Foundation\Application
     */
    protected $app;
