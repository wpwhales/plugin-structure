...
use WPWhales\Contracts\Cookie\Factory as CookieFactory;
...
use WPWhales\Foundation\Bus\PendingClosureDispatch;
use WPWhales\Foundation\Bus\PendingDispatch;
use WPWhales\Foundation\Mix;
...
if (! function_exists('abort')) {
     ...
     *
     * @param  \Symfony\Component\HttpFoundation\Response|\WPWhales\Contracts\Support\Responsable|int  $code
...
if (! function_exists('app')) {
     ...
     * @return \WPWhales\Contracts\Foundation\Application|\WPWhales\Foundation\Application|mixed
     */
...
if (! function_exists('auth')) {
     ...
     * @return \WPWhales\Contracts\Auth\Factory|\WPWhales\Contracts\Auth\Guard|\WPWhales\Contracts\Auth\StatefulGuard
     */
...
if (! function_exists('cache')) {
     ...
     * @return mixed|\WPWhales\Cache\CacheManager
     *
...
if (! function_exists('config')) {
     ...
     * @param  mixed  $default
     * @return mixed|\WPWhales\Config\Repository
     */
...
if (! function_exists('cookie')) {
     ...
     * @return \WPWhales\Cookie\CookieJar|\Symfony\Component\HttpFoundation\Cookie
     */
...
if (! function_exists('logger')) {
     ...
     * @param  array  $context
     * @return \WPWhales\Log\LogManager|null
     */
...
if (! function_exists('logs')) {
     ...
     * @return \WPWhales\Log\LogManager|\Psr\Log\LoggerInterface
     */
...
if (! function_exists('mix')) {
     ...
     * @return \WPWhales\Support\HtmlString|string
     *
     * @throws \Exception
     */
...
if (! function_exists('redirect')) {
     ...
     * @param  array  $headers
     * @param  bool|null  $secure
     * @return \WPWhales\Routing\Redirector|\WPWhales\Http\RedirectResponse
     */
...
if (! function_exists('request')) {
     ...
     * @param  array|string|null  $key
     * @param  mixed  $default
     * @return mixed|\WPWhales\Http\Request|string|array|null
     */
...
if (! function_exists('response')) {
     ...
     *
     * @param  \WPWhales\Contracts\View\View|string|array|null  $content
     * @param  int  $status
     * @param  array  $headers
     * @return \WPWhales\Http\Response|\WPWhales\Contracts\Routing\ResponseFactory
     */
...
if (! function_exists('session')) {
     ...
     * @param  array|string|null  $key
     * @param  mixed  $default
     * @return mixed|\WPWhales\Session\Store|\WPWhales\Session\SessionManager
     */
...
if (! function_exists('trans')) {
     ...
     * @param  array  $replace
     * @param  string|null  $locale
     * @return \WPWhales\Contracts\Translation\Translator|string|array|null
     */
...
if (! function_exists('validator')) {
     ...
     * @return \WPWhales\Contracts\Validation\Validator|\WPWhales\Contracts\Validation\Factory
     */
...
if (! function_exists('view')) {
     ...
     * @return \WPWhales\Contracts\View\View|\WPWhales\Contracts\View\Factory
     */
