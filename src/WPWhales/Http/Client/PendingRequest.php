...
use WPWhales\Http\Client\Events\ConnectionFailed;
use WPWhales\Http\Client\Events\RequestSending;
use WPWhales\Http\Client\Events\ResponseReceived;
...
class PendingRequest
{
     ...
     *
     * @var \WPWhales\Http\Client\Factory|null
     */
    protected $factory;
     ...
     *
     * @var \WPWhales\Support\Collection|null
     */
     ...
     *
     * @var \WPWhales\Http\Client\Request|null
     */
    protected $request;
     ...
     *
     * @param  \WPWhales\Http\Client\Factory|null  $factory
     ...
     * @return \WPWhales\Http\Client\Response
     */
     ...
     *
     * @param  callable  $callback
     * @return array<array-key, \WPWhales\Http\Client\Response>
     */
