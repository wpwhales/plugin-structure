...
use WPWhales\Session\SymfonySessionDecorator;
...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * Create a new WPWhales HTTP request from server variables.
     *
     * @return static
     */
     ...
     *
     * @param  \WPWhales\Http\Request  $from
     * @param  \WPWhales\Http\Request|null  $to
     * @return static
     */
    ...
    /**
     * Create an WPWhales request from a Symfony instance.
     *
     ...
     * @param  mixed  $default
     * @return \WPWhales\Routing\Route|object|string|null
     */
