...
use WPWhales\Http\Resources\ConditionallyLoadsAttributes;
use WPWhales\Http\Resources\DelegatesToResource;
...
class JsonResource implements ArrayAccess, JsonSerializable, Responsable, UrlRoutable
{
     ...
     *
     * @param  mixed  $resource
     * @return \WPWhales\Http\Resources\Json\AnonymousResourceCollection
     */
    public static function collection($resource)
    {
        return \WPWCore\Support\tap(static::newCollection($resource), function ($collection) {
     ...
     * @return array|\WPWhales\Contracts\Support\Arrayable|\JsonSerializable
     */
     ...
     *
     * @param  \WPWhales\Http\Request  $request
     * @param  \WPWhales\Http\JsonResponse  $response
     * @return void
     */
