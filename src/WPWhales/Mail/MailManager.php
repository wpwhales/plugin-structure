...
use Closure;
use WPWhales\Contracts\Mail\Factory as FactoryContract;
use WPWhales\Log\LogManager;
use WPWhales\Mail\Transport\ArrayTransport;
use WPWhales\Mail\Transport\LogTransport;
use WPWhales\Mail\Transport\SesTransport;
use WPWhales\Mail\Transport\SesV2Transport;
...
class MailManager implements FactoryContract
{
     ...
     *
     * @param  array  $config
     * @return \WPWhales\Mail\Transport\SesTransport
     */
     ...
     *
     * @param  array  $config
     * @return \WPWhales\Mail\Transport\Se2VwTransport
     */
     ...
     *
     * @param  array  $config
     * @return \WPWhales\Mail\Transport\LogTransport
     */
     ...
     *
     * @return \WPWhales\Mail\Transport\ArrayTransport
     */
     ...
     *
     * @param  \WPWhales\Mail\Mailer  $mailer
     * @param  array  $config
     * @param  string  $type
     * @return void
     */
