...
namespace WPWhales\Mail\Mailables;
...
class Envelope
{
     ...
     *
     * @var \WPWhales\Mail\Mailables\Address|string|null
     */
    public $from;
     ...
     *
     * @param  \WPWhales\Mail\Mailables\Address|string|null  $from
     * @param  array  $to
     * @param  array  $cc
     * @param  array  $bcc
     * @param  array  $replyTo
     ...
     *
     * @param  \WPWhales\Mail\Mailables\Address|string  $address
     ...
     *
     * @param  \WPWhales\Mail\Mailables\Address|array|string  $address
     * @param  string|null  $name
     * @return $this
     */
