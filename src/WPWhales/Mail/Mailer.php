...
namespace WPWhales\Mail;

use Closure;
use WPWhales\Contracts\Events\Dispatcher;
use WPWhales\Contracts\Mail\Mailable as MailableContract;
use WPWhales\Contracts\Mail\Mailer as MailerContract;
use WPWhales\Contracts\Mail\MailQueue as MailQueueContract;
use WPWhales\Contracts\Queue\Factory as QueueContract;
use WPWhales\Contracts\Queue\ShouldQueue;
use WPWhales\Contracts\Support\Htmlable;
use WPWhales\Contracts\View\Factory;
use WPWhales\Mail\Events\MessageSending;
use WPWhales\Mail\Events\MessageSent;
use WPWhales\Mail\Mailables\Address;
...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     *
     * @var \WPWhales\Contracts\Events\Dispatcher|null
     */
    protected $events;
     ...
     *
     * @param  string  $name
     * @param  \WPWhales\Contracts\View\Factory  $views
     * @param  \Symfony\Component\Mailer\Transport\TransportInterface  $transport
     * @param  \WPWhales\Contracts\Events\Dispatcher|null  $events
     * @return void
     */
     ...
     *
     * @param  \WPWhales\Mail\Message  $message
     * @param  string  $view
     * @param  string  $plain
     * @param  string  $raw
     * @param  array  $data
     ...
     *
     * @param  string  $queue
     * @param  \WPWhales\Contracts\Mail\Mailable  $view
     * @return mixed
     */
     ...
     *
     * @param  \WPWhales\Mail\SentMessage  $message
     * @param  array  $data
     * @return void
     */
