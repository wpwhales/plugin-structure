...
use WPWhales\Database\Eloquent\Collection as ModelCollection;
use WPWhales\Database\Eloquent\Model;
use WPWhales\Notifications\Events\NotificationSending;
use WPWhales\Notifications\Events\NotificationSent;
...
class NotificationSender
{
     ...
     *
     * @var \WPWhales\Notifications\ChannelManager
     */
    protected $manager;
     ...
     * @param  \WPWhales\Contracts\Bus\Dispatcher  $bus
     ...
     *
     * @param  mixed  $notifiables
     * @return \WPWhales\Database\Eloquent\Collection|array
     */
