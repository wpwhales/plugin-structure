...
use WPWhales\Contracts\Queue\ClearableQueue;
use WPWhales\Contracts\Queue\Queue as QueueContract;
use WPWhales\Database\Connection;
use WPWhales\Queue\Jobs\DatabaseJob;
use WPWhales\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \WPWhales\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string  $queue
     * @param  \WPWhales\Queue\Jobs\DatabaseJobRecord  $job
     * @param  int  $delay
     * @return mixed
     */
     ...
     *
     * @param  string|null  $queue
     * @return \WPWhales\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \WPWhales\Queue\Jobs\DatabaseJobRecord  $job
     * @return \WPWhales\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  \WPWhales\Queue\Jobs\DatabaseJobRecord  $job
     * @return \WPWhales\Queue\Jobs\DatabaseJobRecord
     */
     ...
     *
     * @param  string  $queue
     * @param  \WPWhales\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
