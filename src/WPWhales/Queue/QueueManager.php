...
use Closure;
use WPWhales\Contracts\Queue\Factory as FactoryContract;
use WPWhales\Contracts\Queue\Monitor as MonitorContract;
...
class QueueManager implements FactoryContract, MonitorContract
{
     ...
     *
     * @param  string  $driver
     * @return \WPWhales\Queue\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
