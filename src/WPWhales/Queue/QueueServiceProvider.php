...
use WPWhales\Queue\Connectors\BeanstalkdConnector;
use WPWhales\Queue\Connectors\DatabaseConnector;
use WPWhales\Queue\Connectors\NullConnector;
use WPWhales\Queue\Connectors\RedisConnector;
use WPWhales\Queue\Connectors\SqsConnector;
use WPWhales\Queue\Connectors\SyncConnector;
use WPWhales\Queue\Failed\DatabaseFailedJobProvider;
use WPWhales\Queue\Failed\DatabaseUuidFailedJobProvider;
use WPWhales\Queue\Failed\DynamoDbFailedJobProvider;
use WPWhales\Queue\Failed\FileFailedJobProvider;
use WPWhales\Queue\Failed\NullFailedJobProvider;
...
class QueueServiceProvider extends ServiceProvider implements DeferrableProvider
{
     ...
     *
     * @param  \WPWhales\Queue\QueueManager  $manager
     * @return void
     */
     ...
     *
     * @param  array  $config
     * @return \WPWhales\Queue\Failed\DatabaseFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \WPWhales\Queue\Failed\DatabaseUuidFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \WPWhales\Queue\Failed\DynamoDbFailedJobProvider
     */
