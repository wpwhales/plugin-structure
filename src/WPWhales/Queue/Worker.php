...
use WPWhales\Contracts\Queue\Factory as QueueManager;
use WPWhales\Database\DetectsLostConnections;
use WPWhales\Queue\Events\JobExceptionOccurred;
use WPWhales\Queue\Events\JobPopped;
use WPWhales\Queue\Events\JobPopping;
use WPWhales\Queue\Events\JobProcessed;
use WPWhales\Queue\Events\JobProcessing;
use WPWhales\Queue\Events\JobReleasedAfterException;
use WPWhales\Queue\Events\JobTimedOut;
use WPWhales\Queue\Events\Looping;
use WPWhales\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     * @param  string  $queue
     * @param  \WPWhales\Queue\WorkerOptions  $options
     * @return int
     */
    ...
    {
        if ($this->cache) {
            return $this->cache->get('WPWhales:queue:restart');
        }
    }
     ...
     *
     * @param  int  $status
     * @param  \WPWhales\Queue\WorkerOptions|null  $options
     * @return never
     */
     ...
     *
     * @param  \WPWhales\Contracts\Queue\Job  $job
     * @return \WPWhales\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @param  \WPWhales\Contracts\Queue\Job  $job
     * @return \WPWhales\Queue\TimeoutExceededException
     */
     ...
     *
     * @return \WPWhales\Contracts\Queue\Factory
     */
