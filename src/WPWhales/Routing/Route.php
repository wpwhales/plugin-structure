...
use WPWhales\Routing\Contracts\CallableDispatcher;
use WPWhales\Routing\Contracts\ControllerDispatcher as ControllerDispatcherContract;
use WPWhales\Routing\Controllers\HasMiddleware;
use WPWhales\Routing\Matching\HostValidator;
use WPWhales\Routing\Matching\MethodValidator;
use WPWhales\Routing\Matching\SchemeValidator;
use WPWhales\Routing\Matching\UriValidator;
...
class Route
{
     ...
     *
     * @return \WPWhales\Routing\Contracts\ControllerDispatcher
     */
