...
use WPWhales\Contracts\Routing\BindingRegistrar;
use WPWhales\Contracts\Routing\Registrar as RegistrarContract;
...
use WPWhales\Routing\Events\PreparingResponse;
use WPWhales\Routing\Events\ResponsePrepared;
use WPWhales\Routing\Events\RouteMatched;
use WPWhales\Routing\Events\Routing;
...
/**
 * @mixin \WPWhales\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \WPWhales\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     *
     * @var \WPWhales\Routing\Route|null
     */
    protected $current;
     ...
     * @param  \WPWhales\Container\Container|null  $container
     * @return void
     */
    ...
    {
        return $this->any($uri, '\WPWhales\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\WPWhales\Routing\ViewController')
                ->setDefaults([
                    'view' => $view,
                    'data' => $data,
     ...
     *
     * @param  \WPWhales\Support\Collection  $middlewares
     * @return array
     */
     ...
     * @throws \WPWhales\Routing\Exceptions\BackedEnumCaseNotFoundException
     */
     ...
     *
     * @return \WPWhales\Routing\RouteCollectionInterface
     */
