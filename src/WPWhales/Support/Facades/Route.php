 ...
 * @method static \WPWhales\Routing\Router substituteImplicitBindingsUsing(callable $callback)
 ...
 * @method static \WPWhales\Routing\RouteRegistrar missing(\Closure $missing)
