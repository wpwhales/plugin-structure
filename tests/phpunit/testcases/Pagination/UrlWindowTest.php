...
use WPWCore\Pagination\UrlWindow;
...
class UrlWindowTest extends TestCase
{
    ...
    public function testPresenterCanGetAUrlRangeForASmallNumberOfUrls()
    {
        $p = new LengthAwarePaginator($array = ['item1', 'item2', 'item3', 'item4'], 4, 2, 2);
        $window = new UrlWindow($p);
        $this->assertEquals(['first' => [1 => '/?wpw_page=1', 2 => '/?wpw_page=2'], 'slider' => null, 'last' => null], $window->get());
    }
    ...
    public function testPresenterCanGetAUrlRangeForAWindowOfLinks()
    {
        ...
        $this->assertEquals(['first' => [1 => '/?wpw_page=1', 2 => '/?wpw_page=2'], 'slider' => $slider, 'last' => [19 => '/?wpw_page=19', 20 => '/?wpw_page=20']], $window->get());
        ...
        $this->assertEquals(['first' => [1 => '/?wpw_page=1', 2 => '/?wpw_page=2'], 'slider' => null, 'last' => $last], $window->get());
    }
