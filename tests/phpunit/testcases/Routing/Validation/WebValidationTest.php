 ...
 *
 */
class WebValidationTest extends \WP_UnitTestCase
{
    ...
    public function test_simple_data_validation_with_invalid_data()
    {
        ...
        $this->app->router->post("/simple_data_validation",["uses"=>TestAjaxValidationController::class."@simple_data_validation"]);

        $this->app["session"]->start();

        $this->app["session"]->setPreviousUrl("/simple_data_validation");

        $response = $this->call("POST", "/simple_data_validation");
    ...
    public function test_simple_data_validation_with_valid_data()
    {
        ...
        $response = $this->call("POST", "/simple_data_validation",["text_field"=>123]);
