...
class WordpressRequestTest extends \WP_UnitTestCase
{
    ...
    public function test_view_with_method()
    {
        ...
        $this->app->wordpressRouter->get("/view_with_method", [
            "uses" => \Tests\Routing\View\TestController::class . "@view_with_method"
        ]);


        $response = $this->wordpressCall("GET", "/view_with_method");
    ...
    public function test_view_exception_is_accessible_in_response(){
        ...
        $this->app->wordpressRouter->get("/view_error_test", [
            function(){
        ...
        $response = $this->wordpressCall("GET", "/view_error_test");
