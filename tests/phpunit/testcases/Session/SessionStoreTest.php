...
use WPWhales\Cookie\CookieJar;
use WPWCore\Session\CookieSessionHandler;
use WPWCore\Session\Store;
...
class SessionStoreTest extends TestCase
{
    ...
    public function test_SessionIsLoadedFromHandler()
    {
    ...
    public function test_SessionMigration()
    {
        $session = $this->getSession();
        $oldId = $session->getId();
    ...
    public function test_SessionRegeneration()
    {
        $session = $this->getSession();
        $oldId = $session->getId();
        $session->getHandler()->shouldReceive('destroy')->never();
    ...
    public function test_CantSetInvalidId()
    {
        $session = $this->getSession();
    ...
    public function test_SessionInvalidate()
    {
        $session = $this->getSession();
        $oldId = $session->getId();
    ...
    public function test_BrandNewSessionIsProperlySaved()
    {
        $session = $this->getSession();
    ...
    public function test_SessionIsProperlyUpdated()
    {
        $session = $this->getSession();
        $session->getHandler()->shouldReceive('read')->once()->andReturn(serialize([
    ...
    public function test_SessionIsReSavedWhenNothingHasChanged()
    {
        $session = $this->getSession();
        $session->getHandler()->shouldReceive('read')->once()->andReturn(serialize([
            '_token' => Str::random(40),
    ...
    public function test_SessionIsReSavedWhenNothingHasChangedExceptSessionId()
    {
        $session = $this->getSession();
        $oldId = $session->getId();
        $token = Str::random(40);
    ...
    public function test_OldInputFlashing()
    {
        $session = $this->getSession();
    ...
    public function test_DataFlashing()
    {
        $session = $this->getSession();
    ...
    public function test_DataFlashingNow()
    {
        $session = $this->getSession();
        $session->now('foo', 'bar');
        $session->now('bar', 0);
    ...
    public function test_DataMergeNewFlashes()
    {
        $session = $this->getSession();
        $session->flash('foo', 'bar');
        $session->put('fu', 'baz');
    ...
    public function test_ReflashWithNow()
    {
        $session = $this->getSession();
        $session->now('foo', 'bar');
        $session->reflash();
    ...
    public function test_HasOldInputWithoutKey()
    {
        $session = $this->getSession();
    ...
    public function test_RegenerateToken()
    {
        $session = $this->getSession();
        $token = $session->token();
    ...
    public function test_SetPreviousUrl()
    {
        $session = $this->getSession();
    ...
    public function test_PasswordConfirmed()
    {
        $session = $this->getSession();
    ...
    public function test_KeyMissing()
    {
        $session = $this->getSession();
        $session->put('foo', 'bar');
    ...
    public function test_RememberMethodCallsPutAndReturnsDefault()
    {
        $session = $this->getSession();
    ...
    public function test_RememberMethodReturnsPreviousValueIfItAlreadySets()
    {
        $session = $this->getSession();
        $session->put('key', 'foo');
    ...
    public function test_ValidationErrorsCanBeSerializedAsJson()
    {
    ...
    public function test_ValidationErrorsCanBeReadAsJson()
    {
        $session = $this->getSession('json');
    ...
    public function test_ItIsMacroable()
    {
