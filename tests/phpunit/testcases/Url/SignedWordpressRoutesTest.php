...
class SignedWordpressRoutesTest extends \WP_UnitTestCase
{
    ...
    public function test_web_route_work_with_signed_route_name()
    {
        ...
        //duplicate for naming  as name url generation is dependent on wordpressRouter ro adminAjaxRouter


        $response = $this->call("GET", $this->app["url"]->signedWordpressRoute("something_for_route_name", ["x" => 1], Carbon::now()->addMonth()));
        $response->assertOk();
    ...
    public function test_web_route_fail_with_malformed_signed_route_using_parameters()
    {
         ...
         */
        $response = $this->call("GET", $this->app["url"]->signedWordpressRoute("something_for_route_name", ["x" => 1], Carbon::now()->addMonth()),["xyz"=>123]);
    ...
    public function test_web_route_fail_with_malformed_signed_route_using_expiry()
    {
        ...
        $response = $this->call("GET", $this->app["url"]->signedWordpressRoute("something_for_route_name", ["x" => 1],$today_add_15_min ));
